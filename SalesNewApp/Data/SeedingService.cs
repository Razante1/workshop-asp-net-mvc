...
using System;
using SalesNewApp.Models.ENUMS;


namespace SalesNewApp.Data
{
    public class SeedingService
    {
        private readonly SalesNewAppContext _context;
        public SeedingService(SalesNewAppContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Alice Johnson", "alice@gmail.com", new DateTime(1995, 8, 12), 1500.0, d2);
            Seller s3 = new Seller(3, "John Smith", "john@gmail.com", new DateTime(1990, 3, 25), 2000.0, d3);
            Seller s4 = new Seller(4, "Emily Davis", "emily@gmail.com", new DateTime(1993, 6, 5), 1200.0, d4);
            Seller s5 = new Seller(5, "Michael Wilson", "michael@gmail.com", new DateTime(1987, 11, 7), 1800.0, d3);
            Seller s6 = new Seller(6, "Sarah Thompson", "sarah@gmail.com", new DateTime(1992, 2, 14), 1300.0, d2);
